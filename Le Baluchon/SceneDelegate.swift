...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene,
        ...
        // Use this method to optionally
        // configure and
        // attach the UIWindow `window`
    ...
    func sceneDidDisconnect(_ scene: UIScene) {
        ...
        // this scene that can be re-created the next time the scene connects.
        // The scene may re-connect later, as its
        // session was not necessarily discarded (see `application:didDiscardSceneSessions` instead).
    }
